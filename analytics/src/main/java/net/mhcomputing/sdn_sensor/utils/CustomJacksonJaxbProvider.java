...
public class CustomJacksonJaxbProvider extends JacksonJsonProvider {
    /**
     ...
     */
    public CustomJacksonJaxbProvider()
    {
     ...
     *    data binding
     */
    public CustomJacksonJaxbProvider(Annotations... annotationsToUse)
    {
     ...
     * is to be used.
     */
    public CustomJacksonJaxbProvider(ObjectMapper mapper, Annotations[] annotationsToUse)
    {
