...
int ss_metadata_prepare_sflow_mac(json_object* jobject, const char* field_name, uint8_t* mac);
int ss_metadata_prepare_sflow_ip(json_object* jobject, const char* field_name, sflow_ip_t* ip);
